...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const elementsToAnimate = document.querySelectorAll(
    ".foto-perfil, .impact, .cabecalho-sub-titulo, .cabecalho-sub-js, .button, .sobre-titulo, .sobre-caixa, .ability, .skills-icons i, .projetos-titulo, .projetos-card, .contatos-titulo, .formulario-contato"
  );
